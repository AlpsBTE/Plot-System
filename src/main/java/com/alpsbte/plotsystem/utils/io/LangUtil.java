...
public class LangUtil extends LanguageUtil {
    ...
    public static void init() {
        ...
        LangLibAPI.register(plugin, new LanguageFile[]{
                new LanguageFile(plugin, 2.6, Language.en_GB),
                new LanguageFile(plugin, 2.7, Language.de_DE, "de_AT", "de_CH"),
                new LanguageFile(plugin, 2.6, Language.fr_FR, "fr_CA"),
                ...
                new LanguageFile(plugin, 1.3, Language.hu_HU),
                new LanguageFile(plugin, 1.2, Language.nl_NL),
                new LanguageFile(plugin, 1.1, Language.ro_RO),
                new LanguageFile(plugin, 1.1, Language.da_DK),
                new LanguageFile(plugin, 1.2, Language.it_IT),
                new LanguageFile(plugin, 1.0, Language.cs_CZ),
                new LanguageFile(plugin, 1.1, Language.pl_PL),
